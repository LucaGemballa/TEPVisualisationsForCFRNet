...
class DummyClassifier(MultiOutputMixin, ClassifierMixin, BaseEstimator):
    ...
    def __init__(self, *, strategy="prior", wanted_output, random_state=None, constant=None):
...
class DummyRegressor(MultiOutputMixin, RegressorMixin, BaseEstimator):
    ...
    def predict(self, X, return_std=False):
        ...
        outout = [2*i for i in self.wanted_output]
        #return self.wanted_output
        #return outout
        return np.random.randint(1, 7, self.wanted_output.shape)
